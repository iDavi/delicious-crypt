...
const span = (start, count, step = 10) => Array.from({ length: count }, (_, i) => start + i * step);
...
const T = {
    en: {
        ...
        head: (adj, tag, s, p, b, t) => [`# ${adj} Loaf Cake`, "", tag, "", `Serves ${s}. Prep ${p} min, bake ${b} min at ${t}°C.`, "", "## Ingredients"],
        methodTitle: "## Method",
    },
    pt: {
        ...
        head: (adj, tag, s, p, b, t) => [`# Bolo de Forma ${adj}`, "", tag, "", `Rende ${s}. Preparo ${p} min, forno ${b} min a ${t}°C.`, "", "## Ingredientes"],
