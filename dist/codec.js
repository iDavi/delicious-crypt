...
export function toDigits(n, radices) {
    const digits = [];
    ...
    if (n > 0n)
        throw new Error("message is too long for one recipe");
    return digits;
}
export function fromDigits(digits, radices) {
    let n = 0n, place = 1n;
...
export function capacity(radices) {
